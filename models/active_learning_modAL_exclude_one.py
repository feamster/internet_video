...
def run_model(X, y, test_size, rep_times, n_queries, estimator, fd):
    ...
    for i in range(rep_times):
        ...
        # print('query no.', 0, file=fd)
        # print('predictions:', predictions_0, file=fd)
        # print('MSE:', err_0, file=fd)
        ...
        for j in range(n_queries):
            ...
            # print('query no.', j+1, file=fd)
            # print('predictions:', predictions, file=fd)
            # print('MSE:', err, file=fd)
...
def sys_main():
    ...
    fd = open('results/misc_data_folder/modAL-result-exclude-one.txt', 'w')
    E1 = []
    E2 = []
    E3 = []
    for usr in usr_list:
